...
INSERT INTO share_home (name, address, description, security, type_animal_id)
VALUES ('Снежок', 'г.Москва, ул.Судостроительная д.12.', 'В нашем приюте “Снежок” находится более 200 собак, которые хотят обрести семью и друзей.
...
INSERT INTO refinfo (document_name, description, share_home_id)
